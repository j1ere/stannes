...
import { logoutAction } from "@/app/actions/logoutAction"; // assuming this still works
            ...
            {isAuthenticated && initialUser ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:block">{initialUser.full_name.split(" ")[0]}</span>
                  <ChevronDown className="w-4 h-4" />
                </button>
                ...
                {userDropdownOpen && (
                  <div className="absolute top-full right-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 backdrop-blur-md">
                    <div className="px-4 py-2 border-b border-gray-100">
                      <p className="text-sm font-medium text-gray-900">{initialUser.full_name}</p>
                      <p className="text-xs text-gray-500">{initialUser.email}</p>
                    </div>
            ...
            {isAuthenticated && initialUser ? (
              <div className="border-t border-gray-200 pt-4 mt-4">
                <div className="px-3 py-2">
                  ...
                  <p className={`text-xs ${isScrolled ? "text-gray-500" : "text-white/70"}`}>{initialUser.email}</p>
                </div>
                <form action={logoutAction}>
