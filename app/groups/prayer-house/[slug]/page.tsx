...
const PrayerHouseDetail = () => {
  const router = useRouter();
  const params = useParams();
  const { slug } = params;

  const house = prayerHouses.find((h) => h.slug === slug);

  if (!house) {
    return (
      <div className="min-h-screen pt-16 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Prayer House Not Found</h1>
    ...
    <div className="min-h-screen pt-16 bg-white">
      ...
      <section className="bg-gradient-to-r from-green-600 to-orange-600 py-8 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          <h1 className="text-3xl font-bold text-white ml-auto">{house.name}</h1>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {house.images.map((imageSrc, index) => (
              <div key={index} className="relative overflow-hidden rounded-xl shadow-md">
                <img
                  src={imageSrc}
                  alt={`${house.name} community event ${index + 1}`}
        ...
        <section className="bg-gray-50 rounded-xl p-8">
          <div className={`h-2 bg-gradient-to-r ${house.gradient} rounded-t-xl mb-6`}></div>
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">{house.name}</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">{house.meetingInfo}</p>
...
export default PrayerHouseDetail;