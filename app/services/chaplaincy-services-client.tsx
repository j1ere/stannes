    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-purple-800 to-green-700 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Chaplaincy Services</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Supporting our community with quality services and staying connected through Catholic news
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {initialServices.map((service) => {
              ...
              const IconComponent = getIconComponent(service.icon)
              return (
                <div key={service.id} className="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Contact Us for Services</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">csa.maseno@stanneschaplaincy.com</p>
                  </div>
                </div>
                <div className="flex items-center">
            ...
            <div className="sticky top-24">
              <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
                ...
                {initialBlogPosts.length === 0 ? (
                  <p className="text-sm text-gray-500 text-center py-8">No news available right now.</p>
                ) : (
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <a href="https://www.vaticannews.va" target="_blank" rel="noopener noreferrer" className="block text-blue-600 hover:text-blue-700 font-medium">
                    Vatican News
                  </a>
                  <a href="https://www.kccb.or.ke" target="_blank" rel="noopener noreferrer" className="block text-blue-600 hover:text-blue-700 font-medium">
                    Catholic Bishops Conference
                  </a>
                  <a href="/prayer/readings" className="block text-blue-600 hover:text-blue-700 font-medium">
                    Daily Readings
                  </a>
                  <a href="/prayer" className="block text-blue-600 hover:text-blue-700 font-medium">
                    Prayer Requests
                  </a>
                </div>
              </div>
