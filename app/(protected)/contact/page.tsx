...
export const metadata: Metadata = {
  ...
  keywords: ["contact", "location", "Maseno University", "Catholic chaplaincy", "get in touch"],
  openGraph: {
  ...
  const contactInfo: ContactInfo[] = [
    {
      icon: MapPin,
      title: "Location",
      details: ["St. Anne's Chaplaincy", "Maseno University Campus", "Kisumu, Kenya"],
    ...
    },
    {
      icon: Mail,
      title: "Email",
      details: ["info@stanneschaplaincy.org", "csa@stanneschaplaincy.org"],
      color: "from-amber-500 to-amber-600",
    },
    {
      icon: Clock,
      title: "Office Hours",
      details: ["Monday - Friday: 8:00 AM - 5:00 PM", "Saturday: 9:00 AM - 2:00 PM", "Sunday: After Mass"],
  ...
  const keyContacts: KeyContact[] = [
    {
      ...
      email: "chaplain@stanneschaplaincy.org",
      phone: "+254 XXX XXX XXX",
    },
    {
      role: "CSA Chairperson",
      name: "[To be elected]",
      email: "chair@stanneschaplaincy.org",
      phone: "+254 XXX XXX XXX",
    },
    {
      role: "Chaplaincy Chairperson",
      name: "[Community Leader]",
      email: "community@stanneschaplaincy.org",
      phone: "+254 XXX XXX XXX",
    },
  ]
  ...
  return (
    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative bg-gradient-to-br from-green-900 via-emerald-800 to-orange-700 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 max-w-3xl mx-auto">
            Get in touch with St. Anne's Chaplaincy - we're here to welcome you into our Catholic community
          </p>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-amber-50 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Have questions or want to get involved? We'd love to hear from you!</p>
          </div>
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Key Contacts</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {keyContacts.map((contact, index) => (
              ...
              >
                ...
                <p className="text-gray-700 font-medium mb-4">{contact.name}</p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-amber-50 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Find us on the Maseno University campus in Kisumu, Kenya</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>From Kisumu City:</strong> Take the Kisumu-Busia road towards Maseno. The university is
                  clearly signposted along the main road.
                </p>
                <p>
                  <strong>On Campus:</strong> St. Anne's Chaplaincy is located within the university campus. Look for
                  signs directing to the Catholic Chaplaincy.
                </p>
                <p>
                  <strong>Public Transport:</strong> Matatus and buses regularly run from Kisumu to Maseno. Ask the
                  conductor to drop you at the university.
                </p>
              </div>
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>Note:</strong> Visitors are welcome during office hours and for all public masses and events.
                  Please check our events calendar for special activities.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8">Stay connected with our community through social media</p>
      ...
      <section className="py-16 bg-gradient-to-br from-green-900 to-orange-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-green-100">
            We welcome everyone to be part of our Catholic family at St. Anne's Chaplaincy
          </p>
